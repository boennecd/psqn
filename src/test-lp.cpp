...
context("testing lp namespace") {
  test_that("vec_diff works") {
    ...
    double const x[4] = { -0.63, 0.18, -0.84, 1.6 },
  ...
  test_that("mat_vec_dot works (no seperation)") {
    ...
    double const X[n * n] = { 0.58, -0.31, 1.51, 0.39, -0.62, -2.21, 1.12, -0.04, -0.02, 0.94, 0.82, 0.59, 0.92, 0.78, 0.07, -1.99, 0.62, -0.06, -0.16, -1.47, -0.48, 0.42, 1.36, -0.1, 0.39 },
  ...
  test_that("rank_one_update works") {
    ...
    double const x[n]     = { -0.05, -1.38, -0.41, -0.39, -0.06 },
