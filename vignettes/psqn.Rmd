...
An R function which we need to pass to `psqn` to minimize the partially 
...
The partially separable can be minimized like this:
...
at very iteration. This will reduce their computation time. The R version of
